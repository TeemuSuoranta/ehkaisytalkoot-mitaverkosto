 ...
 *
 * @example mita_get_svg('plus')
 * @example mita_get_svg('plus', ['class' => 'icon-more'])
 *
...
function mita_get_svg($icon, $args = array()) {
  ...
  // include icon
  $svg .= '<use xlink:href="' . get_template_directory_uri() . '/dist/sprite/sprite.svg?ver=' . mita_last_edited('svg') . '#icon-' . esc_html($icon) . '"></use>';
