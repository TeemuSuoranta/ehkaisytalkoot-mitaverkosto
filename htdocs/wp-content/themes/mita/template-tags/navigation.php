 ...
 *
 * @example mita_numeric_posts_nav()
 * @example mita_numeric_posts_nav($search, 'filter_p')
 *
 ...
 */
class mita_Pretendable_Walker extends Walker_Page {
...
function mita_sub_pages_navigation() {
  ...
  $walker = new mita_Pretendable_Walker();
