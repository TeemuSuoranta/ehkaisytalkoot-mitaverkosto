 ...
 *
 * @example mita_social_share_buttons()
 */
function mita_social_share_buttons() {
  ...
  <div class="social-share-container">
    ...
    <a data-social-media="LinkedIn" href="<?php echo "https://www.linkedin.com/shareArticle?mini=true&title=$title&url=$url"; ?>" target="_blank" class="social-share-link social-share-linkedin">
      <?php echo mita_get_svg('linkedin'); ?>
 ...
 *
 * @example mita_menu_toggle_btn('menu-toggle')
 * @example mita_menu_toggle_btn('menu-toggle', ['label' => 'Menu'])
 *
